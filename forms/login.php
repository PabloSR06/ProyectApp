    ...
    <div class="mid_page">
        <div class="login">
            <div id="form" class="login_form">
                ...
                <form action="../php/login_act.php" method="post" id="login_form" onkeypress="enterEnviar(event);">
                    <label>
        ...
        <div class="down_link_continer">
            <div  class="down_links">
                <p> <a class="down_link" href="../pages/policies.html">Terminos y Condiciones</a> </p> 
                <p class="down_link_separator"> - </p>
                <p><a class="down_link" href="../forms/contact.html">Contacto</a></p>
            </div> 
        </div>
