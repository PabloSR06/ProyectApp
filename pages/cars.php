...
<body>
    ...
    <div>
        ...
        <?php
            ...
            $db = conectDB();
        ?>
        <p class="text">Aqui encontraras una lista con todos los coches que tienes registrados con nosotros, dale click sobre la matricula para ver más información</p>
    </div>
    ...
    <div>
        <footer class='footer_nav'>
            <nav class='nav_links'>
                ...
                <a href="/proyectapp/pages/" class='nav_link'>
